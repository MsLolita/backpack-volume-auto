...
DELAY_BETWEEN_TRADE = (2, 3)  # Execute delay between every trade (Buy -> Delay -> Sell -> Buy -> Delay ...)
...
TRADE_AMOUNT = [0, 200]  # (works nearly from +-20%), minimum (5$) and maximum amount to trade in USD, if 0 it will trade on FULL balance
ALLOWED_ASSETS = ["SOL_USDC"]
